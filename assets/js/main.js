...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    uz: {
      ...
      'about.title': 'Academy of Arabic — alifbodan erkin so‘zlashuvgacha',
      'about.p1': 'O‘quvchini aniq dastur bo‘ylab olib boramiz: talaffuzni to‘g‘rilash va harakatli matnni o‘qish, so‘ng asosiy grammatika va so‘zlashuv modullari. Har bosqichda nima o‘zlashtirilgani va keyingi qadam nima ekani ko‘rinib turadi.',
      'about.p2': 'Guruhlar 8 kishigacha — o‘qituvchi har bir o‘quvchi bilan ishlashga ulguradi: xatolarni tahlil qiladi, har blokdan keyin qayta aloqa beradi va sur’atni guruh darajasiga moslaydi.',
    ...
    ar: {
      ...
      'about.title': 'أكاديمية العربية — من الحروف إلى الحديث بطلاقة',
      'about.p1': 'نسير مع الطالب وفق برنامج واضح: ضبط النطق وقراءة النص المشكول، ثم القواعد الأساسية فوحدات المحادثة. في كل مرحلة يعرف الطالب ما أتقنه وما هي الخطوة التالية.',
      'about.p2': 'مجموعات لا تتجاوز 8 طلاب، فيتابع المعلم كل طالب: يصحّح الأخطاء، ويقدّم تقييمًا بعد كل وحدة، ويضبط الإيقاع حسب مستوى المجموعة.',
