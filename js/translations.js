...
ru: {
  ...
  about: {
    ...
    lead: "Academy of Arabic — учебный центр в Ташкенте, где взрослые и дети изучают арабский язык системно: от фонетики и грамматики до уверенной разговорной речи.",
...
uz: {
  ...
  about: {
    ...
    lead: "Academy of Arabic — Toshkentdagi o'quv markazi bo'lib, kattalar va bolalar arab tilini tizimli o'rganadi: fonetika va grammatikadan erkin so'zlashuv darajasigacha.",
    ...
    point2Title: "Qulay guruhlar", point2Desc: "Guruhda 20 nafargacha o'quvchi — har biriga e'tibor va tez natija.",
  ...
  teachers: {
    ...
    subtitle: "Markazimizning fonetika, grammatika va Kids guruhlari bo'yicha ustozlari.",
  ...
  reviews: {
    ...
    r2Text: "«O'g'limni Kids guruhiga yozdirdim — yarim yilda ancha erkin gapiradigan bo'ldi va darslarga zavq bilan boradi. Bolalarga yondashuvi uchun ustozga alohida rahmat».",
    r2Name: "Jasur M.", r2Course: "Kids",
    r3Text: "«Grammatika nihoyat o'z o'rniga tushdi — oddiy tilda tushuntirishadi va darhol amaliyotda mustahkamlaymiz. 3 oyda mustaqil o'rgangan bir yildan ko'ra ishonchliroq gapira boshladim».",
    r3Name: "Dilnoza A.", r3Course: "Grammatika",
    r4Text: "«Fonetika kursini noldan boshladim — o'qituvchi har bir tovushni tushunguncha tushuntirdi. Endi ancha ishonchli o'qiyman va talaffuz qilaman».",
  ...
  faq: {
    ...
    a2: "Guruhda 20 nafardan ko'p bo'lmaydi — bu o'qituvchiga har biriga e'tibor berish va har darsda nutqni mashq qilish imkonini beradi.",
...
ar: {
  ...
  about: {
    ...
    lead: "Academy of Arabic مركز تعليمي في طشقند يتعلم فيه الكبار والصغار اللغة العربية بشكل منهجي: من الصوتيات والقواعد إلى مستوى محادثة واثق.",
